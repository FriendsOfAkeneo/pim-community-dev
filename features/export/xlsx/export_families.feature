Feature: Export families in XLSX
  ...
  Scenario: Successfully export families into several files
    ...
    Then I should see the text "xlsx_footwear_family_export_1.xlsx"
    And I should see the text "xlsx_footwear_family_export_2.xlsx"
    And exported xlsx file 1 of "xlsx_footwear_family_export" should contain:
      | code  | attribute_as_label | attributes                                                                                                 | label-en_US | requirements-mobile                             | requirements-tablet                                                       |
    ...
    And exported xlsx file 2 of "xlsx_footwear_family_export" should contain:
      ...
      | sandals  | name               | color,description,manufacturer,name,price,rating,side_view,size,sku                                        | Sandals     | color,name,price,size,sku | color,description,name,price,rating,side_view,size,sku                    |
